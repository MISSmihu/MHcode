...
```json
{"jsonrpc":"2.0","id":"initialize-1","method":"initialize","params":{"protocolVersion":"1.0","host":{"name":"MHcode","version":"0.3.13"},"plugin":{"id":"example-office-helper","version":"1.0.0"}}}
```
